                ...
                <div class="row">
                    <div class="three wide column navigation">
                        <div class="ui secondary stackable vertical pointing menu">
                            <a class="header item brand" href="#"> GeoIP <i class="blue world icon" /> </a>
                            ...
                            <a href="https://github.com/lrstanley/geoip" class="item"> Source on GitHub <i class="purple github icon" /> </a>
                        </div>
                    </div>
                    <div class="ui ten wide column">
                        ...
                        <div class="footer">
                            Location data from <a target="_blank" href="http://www.maxmind.com">Maxmind</a> &middot; GeoIP:
                            <a target="_blank" href="https://github.com/lrstanley/geoip">FOSS</a> lookup service, made with <i class="red heart icon" />
                        </div>
                    </div>
                </div>
            </div>
