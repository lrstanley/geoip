...
import type { BulkGeoResult, GeoResult } from "../src/api/types.gen";

export { expect };

const __dirname = dirname(fileURLToPath(import.meta.url));

export const openapi = readFileSync(resolve(__dirname, "../../internal/handlers/apihandler/openapi_v2.yaml"), {
  encoding: "utf8",
});
...
export function toBulk(requests: APIRequest<GeoResult>[]): APIRequest<BulkGeoResult> {
  ...
  if (!last) {
    throw new Error("toBulk: empty requests");
  }
  return {
